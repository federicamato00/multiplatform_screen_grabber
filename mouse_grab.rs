...
pub fn mouse_grab(current_position_clone:Arc<Mutex<Option<(f64, f64)>>>,is_dragging_clone:Arc<Mutex<Option<bool>>>,start_position_clone:Arc<Mutex<Option<(f64, f64)>>>,end_position_clone:Arc<Mutex<Option<(f64, f64)>>>){
