...
use druid::{AppLauncher,Color, Data, Env,Event,EventCtx, MouseButton, PaintCtx, Point, RenderContext, Widget, WindowDesc, Rect};
extern crate core_graphics;

use core_graphics::display::{CGMainDisplayID, CGDisplayPixelsHigh, CGDisplayBounds};
...
pub struct AppData {
    ...
    start_position_to_display: Option<Point>,
    end_position_to_display: Option<Point>,
    modify:bool,
    is_dragging:bool,
    rect: Rect,
    where_dragging: Option<DragHandle>,
}
        ...
        match event {
            Event::WindowConnected => {
                ...
                let os = env::consts::OS;
                        match os 
                    {
                        ...
                        "macos" => {
                            ...
                            ctx.window().set_size(Size::new(bounds.size.width as f64, height as f64));
               ...
               Event::KeyUp(key_event)=> {
                    ...
                    if key_event.key == Key::Character("m".to_string()) && data.modify==true {
...
fn main() {
    ...
    let display_primary = Display::primary().expect("couldn't find primary display");
    println!("MAIN: Larghezza display: {:?}, altezza display : {:?}",display_primary.width(),display_primary.height());
...
fn build_ui(modify:bool) -> impl Widget<AppData> {
